...
#else
//#define TOUCH_CONTROL_DEFAULT		TOUCH_CONTROL_OFF // LB
#define TOUCH_CONTROL_DEFAULT        TOUCH_CONTROL_WIPE_GESTURES // LB - default to wipe gestures
#endif
...
#define GAME_FRAME_DELAY	16 //20	/* frame delay in milliseconds */ LB - 60 FPS
